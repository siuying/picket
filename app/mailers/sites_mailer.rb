class SitesMailer < ActionMailer::Base
  ...
  def notify_error(site_id)
    ...
    mail(:to => Settings.email.receiver, :subject => @subject, :template_name => 'notify_error')
  end
  ...
  def notify_resolved(site_id, downtime)
    ...
    mail(:to => Settings.email.receiver, :subject => @subject, :template_name => 'notify_resolved')
  end  
end
